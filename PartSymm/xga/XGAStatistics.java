...
public class XGAStatistics extends Statistics implements SteadyStateStatisticsForm // , ec.eval.ProvidesBestSoFar
{
	...
	public void postEvaluationStatistics(final EvolutionState state)
	{
		...
		if (doGeneration)
		{
			state.output.println(String.format("Best Individual: %d, Fitness: %f ", best_ind_idx, state.population.subpops[0].individuals[best_ind_idx].fitness.fitness()), statisticslog);
		}
